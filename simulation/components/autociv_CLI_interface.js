function Autociv_CLI_interface(gui)
{
	this.GUI = {};
	this.GUI.gui = gui;
...
Autociv_CLI_interface.prototype.functionParameterCandidates = {}
Autociv_CLI_interface.prototype.initiated = false;
Autociv_CLI_interface.prototype.suggestionsMaxVisibleSize = 350
Autociv_CLI_interface.prototype.inspectorMaxVisibleSize = 350;
Autociv_CLI_interface.prototype.stdOutMaxVisibleSize = 250;
Autociv_CLI_interface.prototype.vlineSize = 19.2;
Autociv_CLI_interface.prototype.spacing = " ".repeat(8);
Autociv_CLI_interface.prototype.list_data = [];
Autociv_CLI_interface.prototype.prefix = "";
Autociv_CLI_interface.prototype.showDepth = 2;
Autociv_CLI_interface.prototype.previewLength = 100;
Autociv_CLI_interface.prototype.searchFilter = "";
Autociv_CLI_interface.prototype.seeOwnPropertyNames = false;
Autociv_CLI_interface.prototype.lastVariableNameExpressionInspector = "";

Autociv_CLI_interface.prototype.functionAutocomplete = new Map([
...
Autociv_CLI_interface.prototype.functionParameterCandidatesLoader = {
	"guiObjectNames": () =>
	{
		let list = [];
		let internal = 0;
...
Autociv_CLI_interface.prototype.searchFilterKeys = {
	"u": "undefined",
	"b": "boolean",
	"n": "number",
	"i": "bigint",
...
Autociv_CLI_interface.prototype.style = {
	"GUI": {
		"input": {
...
Autociv_CLI_interface.prototype.onTick = function ()
{
...
Autociv_CLI_interface.prototype.stdoutToggle = function ()
{
...
Autociv_CLI_interface.prototype.stdoutEval = function ()
{
	if (this.GUI.gui.hidden)
		return;
...
Autociv_CLI_interface.prototype.getFunctionParameterCandidates = function (functionObject)
{
...
Autociv_CLI_interface.prototype.sort = function (value, candidates)
{
	return autociv_matchsort(value, candidates);
};

Autociv_CLI_interface.prototype.sortSearchFilter = function (parent, candidates)
{
...
Autociv_CLI_interface.prototype.getType = function (val)
{
...
Autociv_CLI_interface.prototype.accessFormat = function (value, access, isString, colored = false, type)
{
...
// escapeText from a24
Autociv_CLI_interface.prototype.escape = function (obj)
{
	return obj.toString().replace(/\\/g, "\\\\").replace(/\[/g, "\\[");
};

Autociv_CLI_interface.prototype.inspectSelectedSuggestion = function ()
{
...
Autociv_CLI_interface.prototype.setSelectedSuggestion = function ()
{
	if (this.GUI.suggestions.selected == -1)
		return;
...
Autociv_CLI_interface.prototype.toggle = function ()
{
...
Autociv_CLI_interface.prototype.evalInput = function (text = this.GUI.input.caption)
{
	let representation = "";
	try
	{
...
Autociv_CLI_interface.prototype.getTokens = function (text)
{
...
Autociv_CLI_interface.prototype.getEntry = function (text)
{
...
Autociv_CLI_interface.prototype.getCandidates = function (object, access)
{
	let list = new Set();
...
Autociv_CLI_interface.prototype.getSuggestions = function (entry)
{
...
Autociv_CLI_interface.prototype.getFormattedSuggestionList = function (entry, suggestions)
{
...
Autociv_CLI_interface.prototype.updateSuggestionList = function (entry, suggestions)
{
...
Autociv_CLI_interface.prototype.processPrefixes = function (text)
{
	let original = text;
...
Autociv_CLI_interface.prototype.updateSuggestions = function (text = this.GUI.input.caption, lookForPrefixes = true)
{
...
Autociv_CLI_interface.prototype.tab = function ()
{
...
Autociv_CLI_interface.prototype.getObjectRepresentation = function (obj, depth = this.showDepth, prefix = "", format = true)
{
...
Autociv_CLI_interface.prototype.updateObjectInspector = function (object, text = this.GUI.input.caption)
{
	let time = Engine.GetMicroseconds();
...
Engine.RegisterGlobal("Autociv_CLI_interface",Autociv_CLI_interface)
